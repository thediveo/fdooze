...
contrast, FileDescriptor.Details isn't a generic struct type dump, but instead
is hand-crafted to aid quickly understanding a file descriptor's properties,
using symbolic constant names wherever applicable.
...
the recently introduced Gomega [HaveExistingField] matcher).
